# Generated by Powerlevel10k configuration wizard on 2026-04-16 at 14:31 +04.
...
# blurred heads, flat tails, 1 line, sparse, concise, transient_prompt,
...
() {
  ...
  # Default background color. Empty means transparent, so Windows Terminal's
  # acrylic shows through the prompt instead of a solid block breaking the glass.
  ...
  typeset -g POWERLEVEL9K_LEFT_SEGMENT_SEPARATOR='%242F\uE0B1'
  # Separator between different-color segments on the right.
  typeset -g POWERLEVEL9K_RIGHT_SEGMENT_SEPARATOR='%242F\uE0B3'
